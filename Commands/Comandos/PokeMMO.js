...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const downloadIcon = await icone(interaction.guild, 'download')

        const pokeConteiner = new ContainerBuilder({
            accent_color: 0xf51505
        });
            ...
            new SectionBuilder()
                .addTextDisplayComponents(
                    new TextDisplayBuilder({
                        content: `# PokeMMO \n Bem vindo a nova era de batalha de monstros. \n Não jogue mais sozinho, venha jogar conosco.`
                    })
                )
